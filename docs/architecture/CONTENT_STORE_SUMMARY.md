...
- **Features:** Upload destination selector, content store management
...
└── src/app/upload/                   # Upload UI with content store option
```
...
- `web/src/app/upload/` - Frontend upload UI
- `docs/implementation/CONTENT_STORE_IMPLEMENTATION.md` - Detailed implementation guide
